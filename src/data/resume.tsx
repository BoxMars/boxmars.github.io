...
export const DATA = {
  ...
  description:
    "Computer Science Student. I am looking for a **PhD position** in Computer Science, focusing on **Edge Computeing**, **Large Language Model**. [*Send Email*](mailto:booxmaars@gmail.com)",
  summary:
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "A course review platform for University of Macau students to share their course experience and help others to choose courses.",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
    ...
    },
    {
      ...
      links: [
        ...
        { 
          type: "iOS",
          href: "https://apps.apple.com/us/app/ark-all-%E6%BE%B3%E9%96%80%E5%A4%A7%E5%AD%B8%E6%9C%AC%E7%A7%91%E7%94%9Fumer%E5%BF%85%E5%82%99app/id1636670554",
          icon: <Icons.appstore className="size-3" />,
        },
        {
          type: "Android",
          href: "https://play.google.com/store/apps/details?id=one.umall&pli=1",
          icon: <Icons.googlepaly className="size-3" />,
        },
      ],
      image: "/ark.png",
      video: "",
